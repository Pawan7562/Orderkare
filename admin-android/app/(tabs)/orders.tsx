...
const styles = StyleSheet.create({
  ...
  customerRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 },
  ...
  advanceBtn: { paddingHorizontal: 14, paddingVertical: 7, borderRadius: 10 },
