...
const DEFAULT_TABLES: TableData[] = [
  ...
  { id: 'tbl-2', tableNumber: 2, capacity: 4, status: 'occupied', currentOrderAmt: 640 },
  { id: 'tbl-3', tableNumber: 3, capacity: 4, status: 'available' },
  { id: 'tbl-4', tableNumber: 4, capacity: 6, status: 'occupied', currentOrderAmt: 1250 },
  { id: 'tbl-5', tableNumber: 5, capacity: 2, status: 'reserved' },
  { id: 'tbl-6', tableNumber: 6, capacity: 8, status: 'available' },
  { id: 'tbl-7', tableNumber: 7, capacity: 4, status: 'available' },
  { id: 'tbl-8', tableNumber: 8, capacity: 4, status: 'occupied', currentOrderAmt: 890 },
  { id: 'tbl-9', tableNumber: 9, capacity: 2, status: 'available' },
];
