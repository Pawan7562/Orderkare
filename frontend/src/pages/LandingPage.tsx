    ...
    <div className="min-h-screen bg-[#fafbfe] text-slate-900 font-sans antialiased overflow-x-hidden selection:bg-orange-500 selection:text-white">
      ...
      <footer className="relative bg-slate-900 text-slate-300 pt-20 pb-12 border-t border-slate-800 overflow-hidden font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 relative z-10">
          ...
          {/* 1. High-Converting Pre-Footer Banner */}
          <div className="relative rounded-3xl p-8 sm:p-12 overflow-hidden border border-slate-800 bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 shadow-2xl">
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8 text-left">
              <div className="space-y-3 max-w-2xl">
                <div className="inline-flex items-center gap-2 bg-orange-500/10 border border-orange-500/20 px-3 py-1 rounded-full text-xs font-black text-orange-400 uppercase tracking-wider">
                  <Sparkles className="w-3.5 h-3.5 text-orange-400" />
                  <span>Start Free In 5 Minutes</span>
                </div>
                <h3 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white tracking-tight leading-tight">
                  Ready to Supercharge Your Restaurant's Revenue & Table Turnaround?
                </h3>
                <p className="text-slate-400 text-xs sm:text-sm leading-relaxed">
                  Join 1,200+ top restaurants, cafes, and food courts eliminating order delays and keeping 100% of their profits with 0% commission direct ordering.
                </p>
              ...
              <div className="flex flex-col sm:flex-row lg:flex-col gap-3.5 w-full sm:w-auto shrink-0">
                <Link
                  to="/register"
                  className="px-8 py-4 bg-gradient-to-r from-orange-500 via-amber-500 to-orange-600 hover:from-orange-600 hover:to-amber-600 text-white font-extrabold text-sm rounded-2xl shadow-lg shadow-orange-500/25 transition-all text-center flex items-center justify-center gap-2 active:scale-95 group"
                >
                ...
                <a
                  href="#demo"
                  className="px-8 py-3.5 bg-slate-800 hover:bg-slate-700/80 border border-slate-700 text-white font-bold text-xs rounded-2xl transition-all text-center flex items-center justify-center gap-2 active:scale-95"
                >
          ...
          {/* 2. Newsletter & Industry Insights Box */}
          <div className="bg-slate-800/60 backdrop-blur-md border border-slate-800 rounded-2xl p-6 sm:p-8 flex flex-col lg:flex-row items-center justify-between gap-6 shadow-xl">
            <div className="text-left space-y-1 max-w-xl">
              <div className="flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-orange-400 animate-pulse" />
                <h4 className="font-extrabold text-base text-white tracking-tight">OrderKare Hospitality Digest</h4>
              </div>
              <p className="text-slate-400 text-xs sm:text-sm">
                Get monthly restaurant growth strategies, digital menu optimization tips, and feature releases delivered to your inbox.
              </p>
            </div>
            <form
              onSubmit={(e) => {
            ...
            >
              {subscribed ? (
                <span className="text-emerald-400 font-bold bg-emerald-500/10 border border-emerald-500/30 px-5 py-3 rounded-xl text-xs inline-flex items-center gap-2 shadow-sm">
                ...
                <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-96">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-slate-900 border border-slate-700 rounded-xl text-xs text-white placeholder:text-slate-500 outline-none focus:border-orange-500 transition-all"
                    />
                  </div>
                  <button
                    type="submit"
                    className="px-6 py-3 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-bold rounded-xl transition-all text-xs shrink-0 shadow-md active:scale-95"
                  >
                    Subscribe Free
                  </button>
                </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 lg:gap-10 text-xs text-left">
            {/* Column 1: Brand & Direct Contacts */}
            <div className="col-span-2 md:col-span-1 space-y-4">
              <div className="flex items-center gap-2.5">
                <img src="/logo.jpg" alt="OrderKare" className="h-8 w-8 object-cover rounded-xl border border-slate-700 shadow-md" />
                <span className="font-black text-white text-lg tracking-tight">Order<span className="text-orange-500">Kare</span></span>
              </div>
              <p className="text-slate-400 leading-relaxed text-xs">
                Empowering modern restaurants with sub-second QR table ordering, real-time kitchen displays (KDS), and 0% commission direct UPI payments.
              </p>

              {/* Live System Status Pill */}
              <div className="inline-flex items-center gap-2 bg-emerald-950/60 border border-emerald-500/30 px-3 py-1.5 rounded-full text-[11px] font-bold text-emerald-300">
              ...
              <div className="pt-2 text-[11px] text-slate-400 space-y-2">
                ...
                <p className="flex items-center gap-2">
                  ...
                  <a href={`mailto:${supportEmail}`} className="text-slate-300 hover:text-orange-400 font-medium transition-colors">{supportEmail}</a>
                </p>
                <p className="flex items-center gap-2">
                  <Phone className="w-3.5 h-3.5 text-orange-400 shrink-0" />
                  <a href={`tel:${supportPhone}`} className="text-slate-300 hover:text-orange-400 font-medium transition-colors">{supportPhone}</a>
                </p>
              </div>
            </div>

            {/* Column 2: Core Platform (Product) */}
            <div className="space-y-3.5">
              ...
              <ul className="space-y-2.5 text-slate-400 font-medium">
                <li>
                  <a href="#features" className="hover:text-white transition-colors flex items-center justify-between">
                    <span>QR Table Ordering</span>
                    <span className="text-[9px] bg-orange-500/20 text-orange-400 px-1.5 py-0.5 rounded font-bold">Popular</span>
                  </a>
                </li>
                <li>
                  <a href="#platform" className="hover:text-white transition-colors flex items-center justify-between">
                    <span>Kitchen Display (KDS)</span>
                    <span className="text-[9px] bg-emerald-500/20 text-emerald-400 px-1.5 py-0.5 rounded font-bold">Live Sync</span>
                  </a>
                </li>
                ...
                <li><a href="#features" className="hover:text-white transition-colors">Live Feedback Manager</a></li>
              </ul>
            </div>
            ...
            <div className="space-y-3.5">
              ...
              <ul className="space-y-2.5 text-slate-400 font-medium">
                <li><span className="hover:text-white cursor-default transition-colors">Fine Dining & Bistros</span></li>
                <li><span className="hover:text-white cursor-default transition-colors">Quick Service (QSR)</span></li>
                <li><span className="hover:text-white cursor-default transition-colors">Cafes & Bakeries</span></li>
                <li><span className="hover:text-white cursor-default transition-colors">Food Courts & Bars</span></li>
                <li><span className="hover:text-white cursor-default transition-colors">Cloud Kitchens</span></li>
                <li><span className="hover:text-white cursor-default transition-colors">Multi-Branch Chains</span></li>
              </ul>
            </div>
            ...
            <div className="space-y-3.5">
              ...
              <ul className="space-y-2.5 text-slate-400 font-medium">
                <li><Link to="/login" className="hover:text-white transition-colors">Restaurant Admin Sign In</Link></li>
                ...
                <li><Link to="/login" className="hover:text-white transition-colors">Staff & Waiter Access</Link></li>
            ...
            <div className="space-y-3.5">
              ...
              <ul className="space-y-2.5 text-slate-400 font-medium">
                <li><button onClick={() => setLegalModal('privacy')} className="hover:text-white transition-colors text-left">Privacy Policy</button></li>
                <li><button onClick={() => setLegalModal('terms')} className="hover:text-white transition-colors text-left">Terms of Service</button></li>
                <li><span className="text-slate-400">0% Commission Guarantee</span></li>
                <li><span className="text-slate-400">256-Bit TLS Encryption</span></li>
          ...
          <div className="pt-8 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-4 text-xs text-slate-400">
            <div className="flex flex-wrap items-center gap-4 sm:gap-6">
              <span className="inline-flex items-center gap-1.5 text-slate-300 font-medium">
                ...
                <span>256-Bit Bank-Grade TLS</span>
              </span>
              <span className="inline-flex items-center gap-1.5 text-slate-300 font-medium">
                <Zap className="w-4 h-4 text-amber-400" />
                <span>Sub-Second Real-Time Sync</span>
              </span>
              <span className="inline-flex items-center gap-1.5 text-slate-300 font-medium">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white rounded-lg transition-all text-xs font-bold cursor-pointer"
            >
          ...
          <div className="pt-6 border-t border-slate-800/80 flex flex-col lg:flex-row items-center justify-between gap-4 text-xs text-slate-500">
            <p>© 2026 OrderKare Technologies Pvt. Ltd. All rights reserved.</p>
            <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2">
              <button onClick={() => setLegalModal('privacy')} className="hover:text-slate-300 transition-colors font-medium">Privacy Policy</button>
              <span className="text-slate-700">·</span>
              <button onClick={() => setLegalModal('terms')} className="hover:text-slate-300 transition-colors font-medium">Terms of Service</button>
              <span className="text-slate-700">·</span>
